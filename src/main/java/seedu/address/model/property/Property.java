...
public class Property {
     ...
     */
    public Property(Person owner, Address address, Price price) {
        this(owner, address, price, new ArrayList<>());
    }

    /**
     * Every field must be present and not null.
     */
    public Property(Person owner, Address address, Price price, List<Person> interestedPersons) {
    ...
    public Property addInterestedPerson(Person person) {
        ...
        if (person.equals(owner)) {
            throw new IllegalArgumentException("Owner cannot be added as an interested person");
        }
