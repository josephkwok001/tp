...
public class JsonAdaptedPersonTest {
    ...
    /** Use sample properties' names for interested list (JSON stores names). */
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, Collections.emptyList(), VALID_INTERESTED_PROP_NAMES);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        invalidTags, Collections.emptyList(), VALID_INTERESTED_PROP_NAMES);
    ...
    @Test
    public void toRawJsonString_returnsParsableCompactJson() {
        JsonAdaptedPerson adapted = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                Collections.emptyList(), VALID_INTERESTED_PROP_NAMES);
        ...
        org.junit.jupiter.api.Assertions.assertTrue(
                hasBraces && hasNameKey && hasPhoneKey && hasEmailKey && hasAddressKey && hasOwnedPropsKey);
    }
