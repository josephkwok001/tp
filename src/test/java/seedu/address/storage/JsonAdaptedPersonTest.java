...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_LISTING, VALID_TAGS, Collections.emptyList());
    ...
    public void toModelType_nullListing_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, null, VALID_TAGS, Collections.emptyList());
    ...
    public void invalidFieldKeys_allInvalidFieldsReported() {
        JsonAdaptedPerson adapted = new JsonAdaptedPerson(
                INVALID_NAME, INVALID_PHONE, INVALID_EMAIL, INVALID_ADDRESS, INVALID_LISTING, null, null);
    ...
    public void toRawJsonString_returnsParsableCompactJson() throws Exception {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(hasBraces
                && hasNameKey && hasPhoneKey && hasEmailKey && hasAddressKey && hasListingKey && hasOwnedPropsKey);
    }
