...
public class PersonBuilder {
    ...
    public static final String DEFAULT_LISTING = "Condo";
    ...
    /**
     * Sets the {@code Listing} of the {@code Person} that we are building.
     */
    public PersonBuilder withListing(String listing) {
