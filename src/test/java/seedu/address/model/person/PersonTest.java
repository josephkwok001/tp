...
public class PersonTest {
    ...
    public void isSamePerson_differentName_false() {
        Person a = person("Alice Bob", "91234567", "alice@example.com", "1 Main St", Set.of());
        Person b = person("Charlie Tan", "91234567", "alice@example.com", "1 Main St", Set.of());
        org.junit.jupiter.api.Assertions.assertFalse(a.isSamePerson(b));
    }

    @Test
    public void equalsAndHashCodeContract() {
        Person a = person("Alice Bob", "91234567", "alice@example.com", "1 Main St", Set.of(new Tag("x")));
        Person b = person("Alice Bob", "91234567", "alice@example.com", "1 Main St", Set.of(new Tag("x")));
        Person c = person("Alice Bob", "93334444", "alice@example.com", "1 Main St", Set.of(new Tag("x")));
