...
public class SetOwnedPropertyCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        String userInput = " " + CliSyntax.PREFIX_PERSON_INDEX + "1 "
    ...
    public void parse_invalidIndex_failure() {
        String userInput = " " + CliSyntax.PREFIX_PERSON_INDEX + "0 "
    ...
    public void parse_duplicatePrefixes_failure() {
        String userInput = " " + CliSyntax.PREFIX_PERSON_INDEX + "1 "
                + CliSyntax.PREFIX_PERSON_INDEX + "2 "
                + CliSyntax.PREFIX_NAME + "City Loft";
        assertParseFailure(parser, userInput,
                Messages.getErrorMessageForDuplicatePrefixes(CliSyntax.PREFIX_PERSON_INDEX));
    }

    @Test
    public void parse_nonEmptyPreamble_failure() {
        String userInput = "abc "
                + CliSyntax.PREFIX_PERSON_INDEX + "1 "
                + CliSyntax.PREFIX_NAME + "City Loft";
        assertParseFailure(parser, userInput,
                String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, SetOwnedPropertyCommand.MESSAGE_USAGE));
    }
